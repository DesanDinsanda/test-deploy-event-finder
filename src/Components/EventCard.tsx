...
function EventCard({ event }: Props) {
  return (
    <>
      <div className="group m-5  bg-[#151e32] border border-slate-700 rounded-xl overflow-hidden text-white w-full  md:w-[320px] lg:w-[300px] xl:w-[320px] 2xl:w-[380px] hover:border-cyan-400 hover:shadow-cyan-400/50 hover:shadow-lg transition-all hover:scale-103 hover:-translate-y-1">
